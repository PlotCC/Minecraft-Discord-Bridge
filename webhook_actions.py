...
class regex_action:
    ...
    def __init__(self, regex: str, on_match: Callable):
        self.regex = regex
...
class multi_regex_action(regex_action):
    """
...
class action_list:
    ...
    def __init__(self, actions: list[regex_action|multi_regex_action]):
